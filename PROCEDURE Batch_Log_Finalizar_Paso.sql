...
IF OBJECT_ID('[dbo].[Batch_Log_Finalizar_Paso]') IS NULL
	EXEC ('CREATE PROCEDURE [dbo].[Batch_Log_Finalizar_Paso] AS SET NOCOUNT ON;')
GO

ALTER PROCEDURE [dbo].[Batch_Log_Finalizar_Paso] (
